...
/**
 * Request for verifying a company (simple).
 *
 * This request sends a GET request to retrieve basic information about a company.
 *
 ...
 */
final class VerifyCompanySimpleRequest extends Request
{
    protected Method $method = Method::GET;

    /**
     * Create a new verify company simple request.
     *
    ...
    {
        return "/verify/company/simple/{$this->id}";
    }
