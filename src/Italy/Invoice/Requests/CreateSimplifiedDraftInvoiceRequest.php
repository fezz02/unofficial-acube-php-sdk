...
/**
 * Request for creating a simplified draft invoice.
 *
 * This request sends a POST request to create a new simplified invoice in draft mode.
 ...
 */
final class CreateSimplifiedDraftInvoiceRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * Create a new create simplified draft invoice request.
     *
     * @param  CreateSimplifiedDraftInvoiceRequestDto  $data  The request data including invoice data
     */
    public function __construct(
        public readonly CreateSimplifiedDraftInvoiceRequestDto $data
    ) {}
    ...
    {
        return '/invoices/simplified/draft';
    }
