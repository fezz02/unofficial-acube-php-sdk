...
/**
 * Data Transfer Object for a single API configuration.
 *
 * Represents an API configuration resource returned by the A-Cube Italy API.
 *
 * @see https://docs.acubeapi.com/documentation/gov-it/
 */
final readonly class ApiConfigurationDto extends Dto
{
    /**
     * Create a new API configuration DTO.
     *
     * @param  string  $uuid  The unique identifier of the API configuration
     * @param  string  $event  The event type
     * @param  string  $target_url  The target URL for the webhook
     * @param  string|null  $authentication_type  The authentication type ("query" or "header")
