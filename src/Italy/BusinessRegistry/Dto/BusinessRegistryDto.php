...
/**
 * Data Transfer Object representing a Business Registry entry.
 *
 * This DTO represents a business registry entry with all its properties.
 *
 * @see https://docs.acubeapi.com/documentation/gov-it/business-registry/
 */
final readonly class BusinessRegistryDto extends Dto
{
    /**
     * Create a new business registry DTO.
     *
     * @param  string|null  $uuid  The UUID of the business registry entry
     * @param  string|null  $head_office_address_street  The head office street address
     * @param  string|null  $head_office_address_street_number  The head office street number
     * @param  string|null  $head_office_address_zip_code  The head office ZIP code
     * @param  string|null  $head_office_address_city  The head office city
     * @param  string|null  $head_office_address_province  The head office province
     * @param  string|null  $head_office_address_country  The head office country (ISO 3166-1 alpha-2)
    ...
    public function __construct(
        ...
        public ?string $head_office_address_street = null,
        public ?string $head_office_address_street_number = null,
        public ?string $head_office_address_zip_code = null,
        public ?string $head_office_address_city = null,
        public ?string $head_office_address_province = null,
        public ?string $head_office_address_country = null,
