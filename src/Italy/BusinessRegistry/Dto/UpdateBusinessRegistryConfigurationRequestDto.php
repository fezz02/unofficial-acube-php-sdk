...
/**
 * Data Transfer Object for updating a Business Registry Configuration.
 *
 * This DTO contains the required and optional fields for updating an existing business registry configuration.
 *
 * @see https://docs.acubeapi.com/documentation/gov-it/business-registry-configuration/
 */
final readonly class UpdateBusinessRegistryConfigurationRequestDto extends Dto
{
    /**
     * Create a new update business registry configuration request DTO.
     *
     ...
     * @param  array<int, array<string, mixed>>|null  $api_configurations  The API configurations (webhooks). Pass null to not update this field.
     */
