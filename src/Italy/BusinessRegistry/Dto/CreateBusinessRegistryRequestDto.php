...
/**
 * Data Transfer Object for creating a Business Registry entry.
 *
 * This DTO contains the required and optional fields for creating a new business registry entry.
 *
 * @see https://docs.acubeapi.com/documentation/gov-it/business-registry/
 */
final readonly class CreateBusinessRegistryRequestDto extends Dto
{
    /**
     * Create a new create business registry request DTO.
     *
