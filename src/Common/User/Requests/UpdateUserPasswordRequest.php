...
/**
 * Request for updating a user password.
 *
 * This request sends a PUT request to update the password of a user.
 * The ID can be "me" to update the current authenticated user's password.
 *
 ...
 */
final class UpdateUserPasswordRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * Create a new update user password request.
     *
     * @param  UpdateUserPasswordRequestDto  $data  The password data including user ID
     */
    public function __construct(
        public readonly UpdateUserPasswordRequestDto $data
    ) {}
    ...
    {
        return "/users/{$this->data->id}/change-password";
    }
