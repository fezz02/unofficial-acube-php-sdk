...
/**
 * Request for retrieving a single pre-sale action by UUID.
 *
 * This request sends a GET request to retrieve a specific pre-sale action by its UUID.
 *
 ...
 */
final class GetPreSaleActionRequest extends Request
{
    protected Method $method = Method::GET;

    /**
     * Create a new get pre-sale action request.
     *
     ...
     * @return PreSaleActionDto The response DTO containing the pre-sale action data
     */
